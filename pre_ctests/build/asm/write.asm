...
/root/oskernel2024-trustos/pre_ctests/build/riscv64/write:     file format elf64-littleriscv
...
void test_write(){
    ...
    107e:	e7e50513          	add	a0,a0,-386 # 1ef8 <__clone+0x40>
}
    ...
    10b8:	4881                	li	a7,0
{
    ...
    10cc:	eb068693          	add	a3,a3,-336 # 1f78 <digits>
    buf[16] = 0;
    ...
    12f8:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    1328:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x58b8>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    132c:	00001997          	auipc	s3,0x1
    1330:	c4c98993          	add	s3,s3,-948 # 1f78 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    1866:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedf87>
    ...
    1878:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff189>
    ...
    18c6:	00757713          	and	a4,a0,7
{
    ...
    18f6:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e189>
    ...
    191a:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedf87>
    191e:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff189>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19b4:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedf87>
    ...
    19c6:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff189>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a7a:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedf87>
    1a7e:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff189>
