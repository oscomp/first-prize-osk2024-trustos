...
/root/oskernel2024-trustos/pre_ctests/build/riscv64/brk:     file format elf64-littleriscv
...
void test_brk(){
    ...
    100a:	eea50513          	add	a0,a0,-278 # 1ef0 <__clone+0x2a>
void test_brk(){
    ...
    1040:	edc50513          	add	a0,a0,-292 # 1f18 <__clone+0x52>
    1044:	2cc000ef          	jal	1310 <printf>
    brk(cur_pos + 64);
    1048:	04040513          	add	a0,s0,64
    104c:	5f7000ef          	jal	1e42 <brk>
    alloc_pos = brk(0);
    1050:	4501                	li	a0,0
    1052:	5f1000ef          	jal	1e42 <brk>
    ...
    105e:	ede50513          	add	a0,a0,-290 # 1f38 <__clone+0x72>
    1062:	2ae000ef          	jal	1310 <printf>
    brk(alloc_pos + 64);
    1066:	04040513          	add	a0,s0,64
    106a:	5d9000ef          	jal	1e42 <brk>
    alloc_pos_1 = brk(0);
    106e:	4501                	li	a0,0
    1070:	5d3000ef          	jal	1e42 <brk>
    1074:	85aa                	mv	a1,a0
    printf("Alloc again,heap pos: %d\n",alloc_pos_1);
    1076:	00001517          	auipc	a0,0x1
    107a:	ee250513          	add	a0,a0,-286 # 1f58 <__clone+0x92>
    107e:	292000ef          	jal	1310 <printf>
    TEST_END(__func__);
    1082:	00001517          	auipc	a0,0x1
    1086:	ef650513          	add	a0,a0,-266 # 1f78 <__clone+0xb2>
    ...
    109e:	e6e50513          	add	a0,a0,-402 # 1f08 <__clone+0x42>
}
    ...
    10d8:	4881                	li	a7,0
{
    ...
    10ec:	eb868693          	add	a3,a3,-328 # 1fa0 <digits>
    buf[16] = 0;
    ...
    1318:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    1348:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x5890>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    134c:	00001997          	auipc	s3,0x1
    1350:	c5498993          	add	s3,s3,-940 # 1fa0 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    1874:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedf5f>
    ...
    1886:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff161>
    ...
    18d4:	00757713          	and	a4,a0,7
{
    ...
    1904:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e161>
    ...
    1928:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedf5f>
    192c:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff161>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19c2:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedf5f>
    ...
    19d4:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff161>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a88:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedf5f>
    1a8c:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff161>
...
0000000000001de6 <sys_linkat>:
    register long a4 __asm__("a4") = e;
    1de6:	1702                	sll	a4,a4,0x20
    register long a7 __asm__("a7") = n;
    1de8:	02500893          	li	a7,37
    register long a4 __asm__("a4") = e;
    1dec:	9301                	srl	a4,a4,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1dee:	00000073          	ecall
