...
/root/oskernel2024-trustos/pre_ctests/build/riscv64/fork:     file format elf64-littleriscv
...
void test_fork(void){
    ...
    103c:	56b000ef          	jal	1da6 <wait>
	printf("  parent process. wstatus:%d\n", wstatus);
    1040:	45b2                	lw	a1,12(sp)
    1042:	00001517          	auipc	a0,0x1
    1046:	efe50513          	add	a0,a0,-258 # 1f40 <__clone+0x76>
    ...
    1052:	f2a50513          	add	a0,a0,-214 # 1f78 <__clone+0xae>
    ...
    106a:	eaa50513          	add	a0,a0,-342 # 1f10 <__clone+0x46>
    ...
    107c:	ea850513          	add	a0,a0,-344 # 1f20 <__clone+0x56>
    1080:	500000ef          	jal	1580 <panic>
	printf("  child process.\n");
    1084:	00001517          	auipc	a0,0x1
    1088:	edc50513          	add	a0,a0,-292 # 1f60 <__clone+0x96>
    108c:	276000ef          	jal	1302 <printf>
	exit(0);
    1090:	4501                	li	a0,0
    1092:	451000ef          	jal	1ce2 <exit>
    ...
    10ca:	4881                	li	a7,0
{
    ...
    10de:	ec668693          	add	a3,a3,-314 # 1fa0 <digits>
    buf[16] = 0;
    ...
    130a:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    133a:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x5890>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    133e:	00001997          	auipc	s3,0x1
    1342:	c6298993          	add	s3,s3,-926 # 1fa0 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    1878:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedf5f>
    ...
    188a:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff161>
    ...
    18d8:	00757713          	and	a4,a0,7
{
    ...
    1908:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e161>
    ...
    192c:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedf5f>
    1930:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff161>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19c6:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedf5f>
    ...
    19d8:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff161>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a8c:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedf5f>
    1a90:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff161>
