...
/root/oskernel2024-trustos/pre_ctests/build/riscv64/times:     file format elf64-littleriscv
...
void test_times() {
    ...
    100a:	ee250513          	add	a0,a0,-286 # 1ee8 <__clone+0x2a>
void test_times() {
    100e:	e406                	sd	ra,8(sp)
	TEST_START(__func__);
    1010:	2c4000ef          	jal	12d4 <puts>
    1014:	00001517          	auipc	a0,0x1
    1018:	fa450513          	add	a0,a0,-92 # 1fb8 <__func__.0>
    101c:	2b8000ef          	jal	12d4 <puts>
    1020:	00001517          	auipc	a0,0x1
    1024:	ee050513          	add	a0,a0,-288 # 1f00 <__clone+0x42>
    1028:	2ac000ef          	jal	12d4 <puts>

	int test_ret = times(&mytimes);
    102c:	00001517          	auipc	a0,0x1
    1030:	f6c50513          	add	a0,a0,-148 # 1f98 <mytimes>
    1034:	4d3000ef          	jal	1d06 <times>
	assert(test_ret >= 0);
    ...
    105c:	f2850513          	add	a0,a0,-216 # 1f80 <__clone+0xc2>
    1060:	274000ef          	jal	12d4 <puts>
    1064:	00001517          	auipc	a0,0x1
    1068:	f5450513          	add	a0,a0,-172 # 1fb8 <__func__.0>
    106c:	268000ef          	jal	12d4 <puts>
}
    1070:	60a2                	ld	ra,8(sp)
	TEST_END(__func__);
    1072:	00001517          	auipc	a0,0x1
    1076:	e8e50513          	add	a0,a0,-370 # 1f00 <__clone+0x42>
}
    ...
    1082:	e9250513          	add	a0,a0,-366 # 1f10 <__clone+0x52>
    ...
    10be:	4881                	li	a7,0
{
    ...
    10d2:	efa68693          	add	a3,a3,-262 # 1fc8 <digits>
    buf[16] = 0;
    ...
    12fe:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    132e:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x5868>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1332:	00001997          	auipc	s3,0x1
    1336:	c9698993          	add	s3,s3,-874 # 1fc8 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    186c:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedf37>
    ...
    187e:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff139>
    ...
    18cc:	00757713          	and	a4,a0,7
{
    ...
    18fc:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e139>
    ...
    1920:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedf37>
    1924:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff139>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19ba:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedf37>
    ...
    19cc:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff139>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a80:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedf37>
    1a84:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff139>
...
0000000000001dde <sys_linkat>:
    register long a4 __asm__("a4") = e;
    1dde:	1702                	sll	a4,a4,0x20
    register long a7 __asm__("a7") = n;
    1de0:	02500893          	li	a7,37
    register long a4 __asm__("a4") = e;
    1de4:	9301                	srl	a4,a4,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1de6:	00000073          	ecall
