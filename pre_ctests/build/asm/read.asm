...
/root/oskernel2024-trustos/pre_ctests/build/riscv64/read:     file format elf64-littleriscv
...
void test_read() {
    ...
    1052:	4505                	li	a0,1
    1054:	443000ef          	jal	1c96 <write>
	close(fd);
    1058:	8522                	mv	a0,s0
    105a:	427000ef          	jal	1c80 <close>
	TEST_END(__func__);
    105e:	00001517          	auipc	a0,0x1
    1062:	ef250513          	add	a0,a0,-270 # 1f50 <__clone+0x82>
    ...
    107a:	e9a50513          	add	a0,a0,-358 # 1f10 <__clone+0x42>
    ...
    108e:	ea650513          	add	a0,a0,-346 # 1f30 <__clone+0x62>
    ...
    10ce:	4881                	li	a7,0
{
    ...
    10e2:	e9a68693          	add	a3,a3,-358 # 1f78 <digits>
    buf[16] = 0;
    ...
    130e:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    133e:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x58b8>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1342:	00001997          	auipc	s3,0x1
    1346:	c3698993          	add	s3,s3,-970 # 1f78 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    187c:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedf87>
    ...
    188e:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff189>
    ...
    18dc:	00757713          	and	a4,a0,7
{
    ...
    190c:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e189>
    ...
    1930:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedf87>
    1934:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff189>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19ca:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedf87>
    ...
    19dc:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff189>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a90:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedf87>
    1a94:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff189>
