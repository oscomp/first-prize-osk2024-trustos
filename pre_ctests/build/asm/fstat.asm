...
/root/oskernel2024-trustos/pre_ctests/build/riscv64/fstat:     file format elf64-littleriscv
...
void test_fstat() {
    ...
    101a:	06250513          	add	a0,a0,98 # 2078 <__func__.0>
    ...
    1034:	f1050513          	add	a0,a0,-240 # 1f40 <__clone+0x52>
    1038:	437000ef          	jal	1c6e <open>
	int ret = fstat(fd, &kst);
    103c:	00001597          	auipc	a1,0x1
    1040:	fbc58593          	add	a1,a1,-68 # 1ff8 <kst>
    1044:	5bf000ef          	jal	1e02 <fstat>
    1048:	842a                	mv	s0,a0
	printf("fstat ret: %d\n", ret);
    104a:	85aa                	mv	a1,a0
    104c:	00001517          	auipc	a0,0x1
    1050:	f0450513          	add	a0,a0,-252 # 1f50 <__clone+0x62>
    1054:	2d2000ef          	jal	1326 <printf>
	assert(ret >= 0);
    1058:	04044b63          	bltz	s0,10ae <test_fstat+0xaa>

	printf("fstat: dev: %d, inode: %d, mode: %d, nlink: %d, size: %d, atime: %d, mtime: %d, ctime: %d\n",
    105c:	00001597          	auipc	a1,0x1
    1060:	f9c58593          	add	a1,a1,-100 # 1ff8 <kst>
    1064:	75a8                	ld	a0,104(a1)
    1066:	0585b883          	ld	a7,88(a1)
    106a:	0485b803          	ld	a6,72(a1)
    106e:	799c                	ld	a5,48(a1)
    1070:	49d8                	lw	a4,20(a1)
    1072:	4994                	lw	a3,16(a1)
    1074:	6590                	ld	a2,8(a1)
    1076:	618c                	ld	a1,0(a1)
    1078:	e02a                	sd	a0,0(sp)
    107a:	00001517          	auipc	a0,0x1
    107e:	f0650513          	add	a0,a0,-250 # 1f80 <__clone+0x92>
    1082:	2a4000ef          	jal	1326 <printf>
    ...
    108a:	f5a50513          	add	a0,a0,-166 # 1fe0 <__clone+0xf2>
    108e:	276000ef          	jal	1304 <puts>
    1092:	00001517          	auipc	a0,0x1
    1096:	fe650513          	add	a0,a0,-26 # 2078 <__func__.0>
    ...
    10a6:	e8e50513          	add	a0,a0,-370 # 1f30 <__clone+0x42>
}
    10aa:	6105                	add	sp,sp,32
	TEST_END(__func__);
    10ac:	aca1                	j	1304 <puts>
	assert(ret >= 0);
    10ae:	00001517          	auipc	a0,0x1
    10b2:	eb250513          	add	a0,a0,-334 # 1f60 <__clone+0x72>
    10b6:	4ee000ef          	jal	15a4 <panic>
    10ba:	b74d                	j	105c <test_fstat+0x58>
...
int main(void) {
	...
	test_fstat();
    10c0:	f45ff0ef          	jal	1004 <test_fstat>
	return 0;
}
    ...
    10ee:	4881                	li	a7,0
{
    ...
    1102:	f8a68693          	add	a3,a3,-118 # 2088 <digits>
    buf[16] = 0;
    ...
    132e:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    135e:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x57a8>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1362:	00001997          	auipc	s3,0x1
    1366:	d2698993          	add	s3,s3,-730 # 2088 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    189c:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefede77>
    ...
    18ae:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff079>
    ...
    18fc:	00757713          	and	a4,a0,7
{
    ...
    192c:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e079>
    ...
    1950:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefede77>
    1954:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff079>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19ea:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefede77>
    ...
    19fc:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff079>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1ab0:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefede77>
    1ab4:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff079>
