...
/root/oskernel2024-trustos/pre_ctests/build/riscv64/yield:     file format elf64-littleriscv
...
int test_yield(){
    ...
    102c:	ee850513          	add	a0,a0,-280 # 1f10 <__clone+0x44>
    ...
    wait(NULL);
    1044:	4501                	li	a0,0
    1046:	563000ef          	jal	1da8 <wait>
    wait(NULL);
    104a:	4501                	li	a0,0
    104c:	55d000ef          	jal	1da8 <wait>
    wait(NULL);
    1050:	4501                	li	a0,0
    1052:	557000ef          	jal	1da8 <wait>
    TEST_END(__func__);
    1056:	00001517          	auipc	a0,0x1
    105a:	efa50513          	add	a0,a0,-262 # 1f50 <__clone+0x84>
    ...
    107c:	e9850513          	add	a0,a0,-360 # 1f10 <__clone+0x44>
}
    ...
    108a:	e9a90913          	add	s2,s2,-358 # 1f20 <__clone+0x54>
                sched_yield();
    108e:	429000ef          	jal	1cb6 <sched_yield>
                printf("  I am child process: %d. iteration %d.\n", getpid(), i);
    1092:	40d000ef          	jal	1c9e <getpid>
    1096:	85aa                	mv	a1,a0
    1098:	8622                	mv	a2,s0
    109a:	854a                	mv	a0,s2
	    for (int j = 0; j< 5; ++j){
    ...
    10de:	4881                	li	a7,0
{
    ...
    10f2:	e8a68693          	add	a3,a3,-374 # 1f78 <digits>
    buf[16] = 0;
    ...
    131e:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    134e:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x58b8>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1352:	00001997          	auipc	s3,0x1
    1356:	c2698993          	add	s3,s3,-986 # 1f78 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    187a:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedf87>
    ...
    188c:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff189>
    ...
    18da:	00757713          	and	a4,a0,7
{
    ...
    190a:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e189>
    ...
    192e:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedf87>
    1932:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff189>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19c8:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedf87>
    ...
    19da:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff189>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a8e:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedf87>
    1a92:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff189>
