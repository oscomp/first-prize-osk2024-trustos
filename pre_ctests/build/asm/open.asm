...
/root/oskernel2024-trustos/pre_ctests/build/riscv64/open:     file format elf64-littleriscv
...
void test_open() {
    ...
    1026:	ef650513          	add	a0,a0,-266 # 1f18 <__clone+0x40>
    102a:	2c4000ef          	jal	12ee <puts>
	// O_RDONLY = 0, O_WRONLY = 1
	int fd = open("./text.txt", 0);
    102e:	4581                	li	a1,0
    1030:	00001517          	auipc	a0,0x1
    1034:	ef850513          	add	a0,a0,-264 # 1f28 <__clone+0x50>
    ...
    1060:	4505                	li	a0,1
    1062:	43f000ef          	jal	1ca0 <write>
	close(fd);
    1066:	8522                	mv	a0,s0
    1068:	423000ef          	jal	1c8a <close>
	TEST_END(__func__);
    106c:	00001517          	auipc	a0,0x1
    1070:	eec50513          	add	a0,a0,-276 # 1f58 <__clone+0x80>
    1074:	27a000ef          	jal	12ee <puts>
    1078:	00001517          	auipc	a0,0x1
    107c:	ef850513          	add	a0,a0,-264 # 1f70 <__func__.0>
    1080:	26e000ef          	jal	12ee <puts>
    1084:	00001517          	auipc	a0,0x1
    1088:	e9450513          	add	a0,a0,-364 # 1f18 <__clone+0x40>
    ...
    109c:	ea050513          	add	a0,a0,-352 # 1f38 <__clone+0x60>
    ...
    10d8:	4881                	li	a7,0
{
    ...
    10ec:	e9868693          	add	a3,a3,-360 # 1f80 <digits>
    buf[16] = 0;
    ...
    1318:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    1348:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x58b0>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    134c:	00001997          	auipc	s3,0x1
    1350:	c3498993          	add	s3,s3,-972 # 1f80 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    1886:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedf7f>
    ...
    1898:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff181>
    ...
    18e6:	00757713          	and	a4,a0,7
{
    ...
    1916:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e181>
    ...
    193a:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedf7f>
    193e:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff181>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19d4:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedf7f>
    ...
    19e6:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff181>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a9a:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedf7f>
    1a9e:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff181>
