...
/root/oskernel2024-trustos/pre_ctests/build/riscv64/mmap:     file format elf64-littleriscv
...
void test_mmap(void){
    ...
    100a:	f3a50513          	add	a0,a0,-198 # 1f40 <__clone+0x2e>
void test_mmap(void){
    ...
    101c:	05050513          	add	a0,a0,80 # 2068 <__func__.0>
    1020:	31a000ef          	jal	133a <puts>
    1024:	00001517          	auipc	a0,0x1
    1028:	f3450513          	add	a0,a0,-204 # 1f58 <__clone+0x46>
    ...
    1038:	f3450513          	add	a0,a0,-204 # 1f68 <__clone+0x56>
    103c:	457000ef          	jal	1c92 <open>
    1040:	842a                	mv	s0,a0
    write(fd, str, strlen(str));
    1042:	00001517          	auipc	a0,0x1
    1046:	f3650513          	add	a0,a0,-202 # 1f78 <__clone+0x66>
    104a:	053000ef          	jal	189c <strlen>
    104e:	862a                	mv	a2,a0
    1050:	00001597          	auipc	a1,0x1
    1054:	f2858593          	add	a1,a1,-216 # 1f78 <__clone+0x66>
    1058:	8522                	mv	a0,s0
    105a:	481000ef          	jal	1cda <write>
    fstat(fd, &kst);
    105e:	00001917          	auipc	s2,0x1
    1062:	f8a90913          	add	s2,s2,-118 # 1fe8 <kst>
    1066:	85ca                	mv	a1,s2
    1068:	8522                	mv	a0,s0
    106a:	5bd000ef          	jal	1e26 <fstat>
    printf("file len: %d\n", kst.st_size);
    106e:	03093583          	ld	a1,48(s2)
    1072:	00001517          	auipc	a0,0x1
    1076:	f2650513          	add	a0,a0,-218 # 1f98 <__clone+0x86>
    ...
    10a0:	f1c50513          	add	a0,a0,-228 # 1fb8 <__clone+0xa6>
    ...
    10ac:	8526                	mv	a0,s1
    10ae:	535000ef          	jal	1de2 <munmap>
    10b2:	64a2                	ld	s1,8(sp)
    }

    close(fd);
    10b4:	8522                	mv	a0,s0
    10b6:	40f000ef          	jal	1cc4 <close>

    TEST_END(__func__);
    10ba:	00001517          	auipc	a0,0x1
    10be:	f1650513          	add	a0,a0,-234 # 1fd0 <__clone+0xbe>
    10c2:	278000ef          	jal	133a <puts>
    10c6:	00001517          	auipc	a0,0x1
    10ca:	fa250513          	add	a0,a0,-94 # 2068 <__func__.0>
    ...
    10dc:	e8050513          	add	a0,a0,-384 # 1f58 <__clone+0x46>
}
    ...
    10e8:	ec450513          	add	a0,a0,-316 # 1fa8 <__clone+0x96>
    ...
    1124:	4881                	li	a7,0
{
    ...
    1138:	f4468693          	add	a3,a3,-188 # 2078 <digits>
    buf[16] = 0;
    ...
    1364:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    1394:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x57b8>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1398:	00001997          	auipc	s3,0x1
    139c:	ce098993          	add	s3,s3,-800 # 2078 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    18c0:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefede87>
    ...
    18d2:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff089>
    ...
    1920:	00757713          	and	a4,a0,7
{
    ...
    1950:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e089>
    ...
    1974:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefede87>
    1978:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff089>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    1a0e:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefede87>
    ...
    1a20:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff089>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1ad4:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefede87>
    1ad8:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff089>
...
0000000000001e32 <sys_linkat>:
    register long a4 __asm__("a4") = e;
    1e32:	1702                	sll	a4,a4,0x20
    register long a7 __asm__("a7") = n;
    1e34:	02500893          	li	a7,37
    register long a4 __asm__("a4") = e;
    1e38:	9301                	srl	a4,a4,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1e3a:	00000073          	ecall
...
0000000000001e42 <sys_unlinkat>:
    register long a2 __asm__("a2") = c;
    1e42:	1602                	sll	a2,a2,0x20
    register long a7 __asm__("a7") = n;
    1e44:	02300893          	li	a7,35
    register long a2 __asm__("a2") = c;
    1e48:	9201                	srl	a2,a2,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1e4a:	00000073          	ecall
