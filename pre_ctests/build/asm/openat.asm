...
/root/oskernel2024-trustos/pre_ctests/build/riscv64/openat:     file format elf64-littleriscv
...
void test_openat(void) {
    ...
    */
    close(fd);	
    1080:	8522                	mv	a0,s0
    1082:	41f000ef          	jal	1ca0 <close>
	
    TEST_END(__func__);
    1086:	00001517          	auipc	a0,0x1
    108a:	f3250513          	add	a0,a0,-206 # 1fb8 <__clone+0xca>
    108e:	276000ef          	jal	1304 <puts>
    1092:	00001517          	auipc	a0,0x1
    1096:	f3e50513          	add	a0,a0,-194 # 1fd0 <__func__.0>
    ...
    10b2:	ed250513          	add	a0,a0,-302 # 1f80 <__clone+0x92>
    ...
    10ee:	4881                	li	a7,0
{
    ...
    1102:	ee268693          	add	a3,a3,-286 # 1fe0 <digits>
    buf[16] = 0;
    ...
    132e:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    135e:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x5850>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1362:	00001997          	auipc	s3,0x1
    1366:	c7e98993          	add	s3,s3,-898 # 1fe0 <digits>
        if (!*s)
    ...
    159e:	a2e40413          	add	s0,s0,-1490 # 1fc8 <__clone+0xda>
...
size_t strlen(const char *s)
{
    ...
    189c:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedf1f>
    ...
    18ae:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff121>
    ...
    18fc:	00757713          	and	a4,a0,7
{
    ...
    192c:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e121>
    ...
    1950:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedf1f>
    1954:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff121>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19ea:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedf1f>
    ...
    19fc:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff121>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1ab0:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedf1f>
    1ab4:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff121>
