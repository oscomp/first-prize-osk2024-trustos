...
/root/oskernel2024-trustos/pre_ctests/build/riscv64/dup2:     file format elf64-littleriscv
...
void test_dup2(){
    ...
    1040:	ef450513          	add	a0,a0,-268 # 1f30 <__clone+0x70>
    1044:	007000ef          	jal	184a <strlen>
    1048:	862a                	mv	a2,a0
    104a:	00001597          	auipc	a1,0x1
    104e:	ee658593          	add	a1,a1,-282 # 1f30 <__clone+0x70>
    1052:	06400513          	li	a0,100
    1056:	433000ef          	jal	1c88 <write>
	TEST_END(__func__);
    105a:	00001517          	auipc	a0,0x1
    105e:	ee650513          	add	a0,a0,-282 # 1f40 <__clone+0x80>
    1062:	274000ef          	jal	12d6 <puts>
    1066:	00001517          	auipc	a0,0x1
    106a:	ef250513          	add	a0,a0,-270 # 1f58 <__func__.0>
    106e:	268000ef          	jal	12d6 <puts>
}
    1072:	60a2                	ld	ra,8(sp)
	TEST_END(__func__);
    1074:	00001517          	auipc	a0,0x1
    1078:	e8c50513          	add	a0,a0,-372 # 1f00 <__clone+0x40>
}
    ...
    1084:	e9050513          	add	a0,a0,-368 # 1f10 <__clone+0x50>
    ...
    10c0:	4881                	li	a7,0
{
    ...
    10d4:	e9868693          	add	a3,a3,-360 # 1f68 <digits>
    buf[16] = 0;
    ...
    1300:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    1330:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x58c8>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1334:	00001997          	auipc	s3,0x1
    1338:	c3498993          	add	s3,s3,-972 # 1f68 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    186e:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedf97>
    ...
    1880:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff199>
    ...
    18ce:	00757713          	and	a4,a0,7
{
    ...
    18fe:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e199>
    ...
    1922:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedf97>
    1926:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff199>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19bc:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedf97>
    ...
    19ce:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff199>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a82:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedf97>
    1a86:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff199>
