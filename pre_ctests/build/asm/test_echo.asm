...
/root/oskernel2024-trustos/pre_ctests/build/riscv64/test_echo:     file format elf64-littleriscv
...
int main(int argc, char *argv[]){
    ...
    100a:	e7250513          	add	a0,a0,-398 # 1e78 <__clone+0x28>
int main(int argc, char *argv[]){
    ...
    1018:	e8c50513          	add	a0,a0,-372 # 1ea0 <__clone+0x50>
    101c:	25c000ef          	jal	1278 <puts>
    1020:	00001517          	auipc	a0,0x1
    1024:	ea850513          	add	a0,a0,-344 # 1ec8 <__func__.0>
    1028:	250000ef          	jal	1278 <puts>
    102c:	00001517          	auipc	a0,0x1
    1030:	e8450513          	add	a0,a0,-380 # 1eb0 <__clone+0x60>
    ...
    1062:	4881                	li	a7,0
{
    ...
    1076:	e5e68693          	add	a3,a3,-418 # 1ed0 <digits>
    buf[16] = 0;
    ...
    12a2:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    12d2:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x5960>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    12d6:	00001997          	auipc	s3,0x1
    12da:	bfa98993          	add	s3,s3,-1030 # 1ed0 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    17fe:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefee02f>
    ...
    1810:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff231>
    ...
    185e:	00757713          	and	a4,a0,7
{
    ...
    188e:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e231>
    ...
    18b2:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefee02f>
    18b6:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff231>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    194c:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefee02f>
    ...
    195e:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff231>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a12:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefee02f>
    1a16:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff231>
...
0000000000001c0e <read>:
    register long a7 __asm__("a7") = n;
    1c0e:	03f00893          	li	a7,63
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1c12:	00000073          	ecall
...
0000000000001c22 <getpid>:
    register long a7 __asm__("a7") = n;
    1c22:	0ac00893          	li	a7,172
    __asm_syscall("r"(a7))
    1c26:	00000073          	ecall
...
0000000000001c2e <getppid>:
    register long a7 __asm__("a7") = n;
    1c2e:	0ad00893          	li	a7,173
    __asm_syscall("r"(a7))
    1c32:	00000073          	ecall
...
0000000000001c3a <sched_yield>:
    register long a7 __asm__("a7") = n;
    1c3a:	07c00893          	li	a7,124
    __asm_syscall("r"(a7))
    1c3e:	00000073          	ecall
...
0000000000001c46 <fork>:
    register long a7 __asm__("a7") = n;
    1c46:	0dc00893          	li	a7,220
    register long a0 __asm__("a0") = a;
    1c4a:	4545                	li	a0,17
    register long a1 __asm__("a1") = b;
    1c4c:	4581                	li	a1,0
...
pid_t clone(int (*fn)(void *arg), void *arg, void *stack, size_t stack_size, unsigned long flags)
{
    ...
    1c58:	863a                	mv	a2,a4
    if (stack)
    1c5a:	c191                	beqz	a1,1c5e <clone+0x8>
	stack += stack_size;
    1c5c:	95b6                	add	a1,a1,a3

    return __clone(fn, stack, flags, NULL, NULL, NULL);
    1c5e:	4781                	li	a5,0
    1c60:	4701                	li	a4,0
    1c62:	4681                	li	a3,0
    1c64:	2601                	sext.w	a2,a2
    1c66:	a2ed                	j	1e50 <__clone>
...
0000000000001c72 <waitpid>:
    register long a7 __asm__("a7") = n;
    1c72:	10400893          	li	a7,260
    register long a3 __asm__("a3") = d;
    1c76:	4681                	li	a3,0
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3))
    1c78:	00000073          	ecall
...
0000000000001c98 <times>:
    register long a7 __asm__("a7") = n;
    1c98:	09900893          	li	a7,153
    __asm_syscall("r"(a7), "0"(a0))
    1c9c:	00000073          	ecall
...
0000000000001ca4 <get_time>:

int64 get_time()
{
    1ca4:	1141                	add	sp,sp,-16
    register long a7 __asm__("a7") = n;
    1ca6:	0a900893          	li	a7,169
    register long a0 __asm__("a0") = a;
    1caa:	850a                	mv	a0,sp
    register long a1 __asm__("a1") = b;
    1cac:	4581                	li	a1,0
    ...
    1cb4:	ed09                	bnez	a0,1cce <get_time+0x2a>
    {
        return ((time.sec & 0xffff) * 1000 + time.usec / 1000);
    1cb6:	67a2                	ld	a5,8(sp)
    1cb8:	3e800713          	li	a4,1000
    1cbc:	00015503          	lhu	a0,0(sp)
    1cc0:	02e7d7b3          	divu	a5,a5,a4
    1cc4:	02e50533          	mul	a0,a0,a4
    1cc8:	953e                	add	a0,a0,a5
    }
    else
    {
        return -1;
    ...
    1cca:	0141                	add	sp,sp,16
    1ccc:	8082                	ret
        return -1;
    1cce:	557d                	li	a0,-1
    1cd0:	bfed                	j	1cca <get_time+0x26>

0000000000001cd2 <sys_get_time>:
    register long a7 __asm__("a7") = n;
...
0000000000001cde <time>:
    register long a7 __asm__("a7") = n;
    1cde:	42600893          	li	a7,1062
    __asm_syscall("r"(a7), "0"(a0))
    1ce2:	00000073          	ecall
...
0000000000001cea <sleep>:

int sleep(unsigned long long time)
{
    1cea:	1141                	add	sp,sp,-16
    TimeVal tv = {.sec = time, .usec = 0};
    1cec:	e02a                	sd	a0,0(sp)
    register long a0 __asm__("a0") = a;
    1cee:	850a                	mv	a0,sp
    1cf0:	e402                	sd	zero,8(sp)
    register long a7 __asm__("a7") = n;
    1cf2:	06500893          	li	a7,101
    register long a1 __asm__("a1") = b;
    1cf6:	85aa                	mv	a1,a0
    __asm_syscall("r"(a7), "0"(a0), "r"(a1))
    1cf8:	00000073          	ecall
    if (syscall(SYS_nanosleep, &tv, &tv)) return tv.sec;
    1cfc:	e501                	bnez	a0,1d04 <sleep+0x1a>
    return 0;
    1cfe:	4501                	li	a0,0
}
    ...
    1d02:	8082                	ret
    if (syscall(SYS_nanosleep, &tv, &tv)) return tv.sec;
    1d04:	4502                	lw	a0,0(sp)
}
    1d06:	0141                	add	sp,sp,16
    1d08:	8082                	ret

0000000000001d0a <set_priority>:
    register long a7 __asm__("a7") = n;
    1d0a:	08c00893          	li	a7,140
    __asm_syscall("r"(a7), "0"(a0))
    1d0e:	00000073          	ecall
...
0000000000001d70 <sys_linkat>:
    register long a4 __asm__("a4") = e;
    1d70:	1702                	sll	a4,a4,0x20
    register long a7 __asm__("a7") = n;
    1d72:	02500893          	li	a7,37
    register long a4 __asm__("a4") = e;
    1d76:	9301                	srl	a4,a4,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1d78:	00000073          	ecall
...
0000000000001d80 <sys_unlinkat>:
    register long a2 __asm__("a2") = c;
    1d80:	1602                	sll	a2,a2,0x20
    register long a7 __asm__("a7") = n;
    1d82:	02300893          	li	a7,35
    register long a2 __asm__("a2") = c;
    1d86:	9201                	srl	a2,a2,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1d88:	00000073          	ecall
...
int link(char *old_path, char *new_path)
{
    ...
    register long a0 __asm__("a0") = a;
    1d98:	f9c00513          	li	a0,-100
    register long a1 __asm__("a1") = b;
    1d9c:	85be                	mv	a1,a5
    register long a2 __asm__("a2") = c;
    1d9e:	f9c00613          	li	a2,-100
    register long a4 __asm__("a4") = e;
    1da2:	4701                	li	a4,0
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1da4:	00000073          	ecall
...
0000000000001dac <unlink>:

int unlink(char *path)
{
    1dac:	85aa                	mv	a1,a0
    register long a7 __asm__("a7") = n;
    1dae:	02300893          	li	a7,35
    register long a0 __asm__("a0") = a;
...
0000000000001dc0 <uname>:
    register long a7 __asm__("a7") = n;
    1dc0:	0a000893          	li	a7,160
    __asm_syscall("r"(a7), "0"(a0))
    1dc4:	00000073          	ecall
...
0000000000001dcc <brk>:
    register long a7 __asm__("a7") = n;
    1dcc:	0d600893          	li	a7,214
    __asm_syscall("r"(a7), "0"(a0))
    1dd0:	00000073          	ecall
...
0000000000001de0 <chdir>:
    register long a7 __asm__("a7") = n;
    1de0:	03100893          	li	a7,49
    __asm_syscall("r"(a7), "0"(a0))
    1de4:	00000073          	ecall
...
int mkdir(const char *path, mode_t mode){
    ...
    register long a7 __asm__("a7") = n;
    1df2:	02200893          	li	a7,34
    register long a0 __asm__("a0") = a;
    1df6:	f9c00513          	li	a0,-100
    register long a1 __asm__("a1") = b;
    1dfa:	85be                	mv	a1,a5
    register long a2 __asm__("a2") = c;
    1dfc:	9201                	srl	a2,a2,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1dfe:	00000073          	ecall
...
0000000000001e06 <getdents>:
    register long a7 __asm__("a7") = n;
    1e06:	03d00893          	li	a7,61
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1e0a:	00000073          	ecall
...
0000000000001e12 <pipe>:
    register long a7 __asm__("a7") = n;
    1e12:	03b00893          	li	a7,59
    register long a1 __asm__("a1") = b;
    1e16:	4581                	li	a1,0
    __asm_syscall("r"(a7), "0"(a0), "r"(a1))
    1e18:	00000073          	ecall
...
0000000000001e36 <mount>:
    register long a7 __asm__("a7") = n;
    1e36:	02800893          	li	a7,40
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1e3a:	00000073          	ecall
...
0000000000001e42 <umount>:
    register long a7 __asm__("a7") = n;
    1e42:	02700893          	li	a7,39
    register long a1 __asm__("a1") = b;
    1e46:	4581                	li	a1,0
    __asm_syscall("r"(a7), "0"(a0), "r"(a1))
    1e48:	00000073          	ecall
...
__clone:
	...
	addi a1, a1, -16
    1e50:	15c1                	add	a1,a1,-16
	sd a0, 0(a1)
    1e52:	e188                	sd	a0,0(a1)
	sd a3, 8(a1)
    1e54:	e594                	sd	a3,8(a1)
    ...
    1e5c:	8742                	mv	a4,a6
	li a7, 220 # SYS_clone
    1e5e:	0dc00893          	li	a7,220
	ecall
    1e62:	00000073          	ecall

	beqz a0, 1f
    1e66:	c111                	beqz	a0,1e6a <__clone+0x1a>
	# Parent
	ret
    1e68:	8082                	ret
	...
	# Child
1:      ld a1, 0(sp)
    1e6a:	6582                	ld	a1,0(sp)
	ld a0, 8(sp)
    1e6c:	6522                	ld	a0,8(sp)
	jalr a1
    1e6e:	9582                	jalr	a1
