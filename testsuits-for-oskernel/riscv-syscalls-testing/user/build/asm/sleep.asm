...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/sleep:     file format elf64-littleriscv
...
void test_sleep() {
    ...
    100a:	f1250513          	add	a0,a0,-238 # 1f18 <__clone+0x2c>
void test_sleep() {
    ...
    101c:	f8050513          	add	a0,a0,-128 # 1f98 <__func__.0>
    1020:	2ec000ef          	jal	130c <puts>
    1024:	00001517          	auipc	a0,0x1
    1028:	f0c50513          	add	a0,a0,-244 # 1f30 <__clone+0x44>
    102c:	2e0000ef          	jal	130c <puts>

	int time1 = get_time();
    1030:	511000ef          	jal	1d40 <get_time>
    1034:	0005041b          	sext.w	s0,a0
	assert(time1 >= 0);
    1038:	06044f63          	bltz	s0,10b6 <test_sleep+0xb2>
	int ret = sleep(1);
    103c:	4505                	li	a0,1
    103e:	549000ef          	jal	1d86 <sleep>
	assert(ret == 0);
    1042:	e13d                	bnez	a0,10a8 <test_sleep+0xa4>
	int time2 = get_time();
    1044:	4fd000ef          	jal	1d40 <get_time>
    ...
    1058:	f0c50513          	add	a0,a0,-244 # 1f60 <__clone+0x74>
    ...
    1064:	f2050513          	add	a0,a0,-224 # 1f80 <__clone+0x94>
    1068:	2a4000ef          	jal	130c <puts>
    106c:	00001517          	auipc	a0,0x1
    1070:	f2c50513          	add	a0,a0,-212 # 1f98 <__func__.0>
    ...
    1082:	eb250513          	add	a0,a0,-334 # 1f30 <__clone+0x44>
}
    ...
    10f6:	4881                	li	a7,0
{
    ...
    110a:	ea268693          	add	a3,a3,-350 # 1fa8 <digits>
    buf[16] = 0;
    ...
    1336:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    1366:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x5888>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    136a:	00001997          	auipc	s3,0x1
    136e:	c3e98993          	add	s3,s3,-962 # 1fa8 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    18a4:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedf57>
    ...
    18b6:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff159>
    ...
    1904:	00757713          	and	a4,a0,7
{
    ...
    1934:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e159>
    ...
    1958:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedf57>
    195c:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff159>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19f2:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedf57>
    ...
    1a04:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff159>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1ab8:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedf57>
    1abc:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff159>
...
0000000000001e0c <sys_linkat>:
    register long a4 __asm__("a4") = e;
    1e0c:	1702                	sll	a4,a4,0x20
    register long a7 __asm__("a7") = n;
    1e0e:	02500893          	li	a7,37
    register long a4 __asm__("a4") = e;
    1e12:	9301                	srl	a4,a4,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1e14:	00000073          	ecall
...
0000000000001e1c <sys_unlinkat>:
    register long a2 __asm__("a2") = c;
    1e1c:	1602                	sll	a2,a2,0x20
    register long a7 __asm__("a7") = n;
    1e1e:	02300893          	li	a7,35
    register long a2 __asm__("a2") = c;
    1e22:	9201                	srl	a2,a2,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1e24:	00000073          	ecall
