...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/umount:     file format elf64-littleriscv
...
void test_umount() {
    ...
    101a:	08250513          	add	a0,a0,130 # 2098 <__func__.0>
    101e:	33a000ef          	jal	1358 <puts>
    1022:	00001517          	auipc	a0,0x1
    1026:	f5650513          	add	a0,a0,-170 # 1f78 <__clone+0x40>
    102a:	32e000ef          	jal	1358 <puts>

	printf("Mounting dev:%s to %s\n", device, mntpoint);
    102e:	00001617          	auipc	a2,0x1
    1032:	fea60613          	add	a2,a2,-22 # 2018 <mntpoint>
    1036:	00001597          	auipc	a1,0x1
    103a:	02258593          	add	a1,a1,34 # 2058 <device>
    103e:	00001517          	auipc	a0,0x1
    1042:	f4a50513          	add	a0,a0,-182 # 1f88 <__clone+0x50>
    1046:	334000ef          	jal	137a <printf>
	int ret = mount(device, mntpoint, fs_type, 0, NULL);
    104a:	00001597          	auipc	a1,0x1
    104e:	fce58593          	add	a1,a1,-50 # 2018 <mntpoint>
    1052:	4701                	li	a4,0
    1054:	4681                	li	a3,0
    1056:	00001617          	auipc	a2,0x1
    105a:	f4a60613          	add	a2,a2,-182 # 1fa0 <__clone+0x68>
    105e:	00001517          	auipc	a0,0x1
    1062:	ffa50513          	add	a0,a0,-6 # 2058 <device>
    1066:	6b9000ef          	jal	1f1e <mount>
    106a:	842a                	mv	s0,a0
	printf("mount return: %d\n", ret);
    106c:	85aa                	mv	a1,a0
    106e:	00001517          	auipc	a0,0x1
    1072:	f3a50513          	add	a0,a0,-198 # 1fa8 <__clone+0x70>
    ...
    1080:	f8450513          	add	a0,a0,-124 # 2000 <__clone+0xc8>
    1084:	2d4000ef          	jal	1358 <puts>
    1088:	00001517          	auipc	a0,0x1
    108c:	01050513          	add	a0,a0,16 # 2098 <__func__.0>
    ...
    109c:	ee050513          	add	a0,a0,-288 # 1f78 <__clone+0x40>
}
...
int main(int argc,char *argv[]) {
    ...
    10f8:	f6450513          	add	a0,a0,-156 # 2058 <device>
    ...
    110c:	f1050513          	add	a0,a0,-240 # 2018 <mntpoint>
    ...
    1142:	4881                	li	a7,0
{
    ...
    1156:	f5668693          	add	a3,a3,-170 # 20a8 <digits>
    buf[16] = 0;
    ...
    1382:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    13b2:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x5788>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    13b6:	00001997          	auipc	s3,0x1
    13ba:	cf298993          	add	s3,s3,-782 # 20a8 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    18f0:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefede57>
    ...
    1902:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff059>
    ...
    1950:	00757713          	and	a4,a0,7
{
    ...
    1980:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e059>
    ...
    19a4:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefede57>
    19a8:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff059>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    1a3e:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefede57>
    ...
    1a50:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff059>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1b04:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefede57>
    1b08:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff059>
