...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/gettimeofday:     file format elf64-littleriscv
...
void test_gettimeofday() {
    ...
    100a:	f0250513          	add	a0,a0,-254 # 1f08 <__clone+0x28>
void test_gettimeofday() {
    ...
    1026:	efe50513          	add	a0,a0,-258 # 1f20 <__clone+0x40>
    102a:	2e8000ef          	jal	1312 <puts>
	int test_ret1 = get_time();
    102e:	507000ef          	jal	1d34 <get_time>
	volatile int i = 12500000;	// qemu时钟频率12500000
    1032:	00bec7b7          	lui	a5,0xbec
    1036:	c2078793          	add	a5,a5,-992 # bebc20 <digits+0xbe9c68>
    ...
    1052:	4e3000ef          	jal	1d34 <get_time>
    ...
    106a:	f0a50513          	add	a0,a0,-246 # 1f70 <__clone+0x90>
    106e:	2c6000ef          	jal	1334 <printf>
	}
	TEST_END(__func__);
    1072:	00001517          	auipc	a0,0x1
    1076:	f1650513          	add	a0,a0,-234 # 1f88 <__clone+0xa8>
    107a:	298000ef          	jal	1312 <puts>
    107e:	00001517          	auipc	a0,0x1
    1082:	f2250513          	add	a0,a0,-222 # 1fa0 <__func__.0>
    ...
    1092:	e9250513          	add	a0,a0,-366 # 1f20 <__clone+0x40>
}
    ...
    10fc:	4881                	li	a7,0
{
    ...
    1110:	eac68693          	add	a3,a3,-340 # 1fb8 <digits>
    buf[16] = 0;
    ...
    133c:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    136c:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x5878>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1370:	00001997          	auipc	s3,0x1
    1374:	c4898993          	add	s3,s3,-952 # 1fb8 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    1898:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedf47>
    ...
    18aa:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff149>
    ...
    18f8:	00757713          	and	a4,a0,7
{
    ...
    1928:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e149>
    ...
    194c:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedf47>
    1950:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff149>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19e6:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedf47>
    ...
    19f8:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff149>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1aac:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedf47>
    1ab0:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff149>
...
0000000000001e00 <sys_linkat>:
    register long a4 __asm__("a4") = e;
    1e00:	1702                	sll	a4,a4,0x20
    register long a7 __asm__("a7") = n;
    1e02:	02500893          	li	a7,37
    register long a4 __asm__("a4") = e;
    1e06:	9301                	srl	a4,a4,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1e08:	00000073          	ecall
...
0000000000001e10 <sys_unlinkat>:
    register long a2 __asm__("a2") = c;
    1e10:	1602                	sll	a2,a2,0x20
    register long a7 __asm__("a7") = n;
    1e12:	02300893          	li	a7,35
    register long a2 __asm__("a2") = c;
    1e16:	9201                	srl	a2,a2,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1e18:	00000073          	ecall
