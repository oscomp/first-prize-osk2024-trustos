...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/getpid:     file format elf64-littleriscv
...
int test_getpid()
{
    ...
    100a:	eca50513          	add	a0,a0,-310 # 1ed0 <__clone+0x2e>
{
    ...
    1024:	ec850513          	add	a0,a0,-312 # 1ee8 <__clone+0x46>
    ...
    103a:	ee250513          	add	a0,a0,-286 # 1f18 <__clone+0x76>
    103e:	2a6000ef          	jal	12e4 <printf>
    TEST_END(__func__);
    1042:	00001517          	auipc	a0,0x1
    1046:	ef650513          	add	a0,a0,-266 # 1f38 <__clone+0x96>
    104a:	278000ef          	jal	12c2 <puts>
    104e:	00001517          	auipc	a0,0x1
    1052:	f0250513          	add	a0,a0,-254 # 1f50 <__func__.0>
    1056:	26c000ef          	jal	12c2 <puts>
}
    105a:	60e2                	ld	ra,24(sp)
    TEST_END(__func__);
    105c:	00001517          	auipc	a0,0x1
    1060:	e8c50513          	add	a0,a0,-372 # 1ee8 <__clone+0x46>
}
    ...
    106e:	e8e50513          	add	a0,a0,-370 # 1ef8 <__clone+0x56>
    ...
    10ac:	4881                	li	a7,0
{
    ...
    10c0:	ea468693          	add	a3,a3,-348 # 1f60 <digits>
    buf[16] = 0;
    ...
    12ec:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    131c:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x58d0>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1320:	00001997          	auipc	s3,0x1
    1324:	c4098993          	add	s3,s3,-960 # 1f60 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    185a:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedf9f>
    ...
    186c:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff1a1>
    ...
    18ba:	00757713          	and	a4,a0,7
{
    ...
    18ea:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e1a1>
    ...
    190e:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedf9f>
    1912:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff1a1>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19a8:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedf9f>
    ...
    19ba:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff1a1>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a6e:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedf9f>
    1a72:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff1a1>
...
0000000000001dc2 <sys_linkat>:
    register long a4 __asm__("a4") = e;
    1dc2:	1702                	sll	a4,a4,0x20
    register long a7 __asm__("a7") = n;
    1dc4:	02500893          	li	a7,37
    register long a4 __asm__("a4") = e;
    1dc8:	9301                	srl	a4,a4,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1dca:	00000073          	ecall
...
0000000000001dd2 <sys_unlinkat>:
    register long a2 __asm__("a2") = c;
    1dd2:	1602                	sll	a2,a2,0x20
    register long a7 __asm__("a7") = n;
    1dd4:	02300893          	li	a7,35
    register long a2 __asm__("a2") = c;
    1dd8:	9201                	srl	a2,a2,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1dda:	00000073          	ecall
