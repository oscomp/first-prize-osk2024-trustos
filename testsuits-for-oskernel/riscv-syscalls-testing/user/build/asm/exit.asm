...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/exit:     file format elf64-littleriscv
...
void test_exit(void){
    ...
    1026:	ee650513          	add	a0,a0,-282 # 1f08 <__clone+0x42>
    ...
    1044:	f1850513          	add	a0,a0,-232 # 1f58 <__clone+0x92>
    1048:	29e000ef          	jal	12e6 <puts>
    104c:	00001517          	auipc	a0,0x1
    1050:	f2450513          	add	a0,a0,-220 # 1f70 <__func__.0>
    1054:	292000ef          	jal	12e6 <puts>
    1058:	00001517          	auipc	a0,0x1
    105c:	eb050513          	add	a0,a0,-336 # 1f08 <__clone+0x42>
    ...
    1070:	eac50513          	add	a0,a0,-340 # 1f18 <__clone+0x52>
    ...
    1086:	ec650513          	add	a0,a0,-314 # 1f48 <__clone+0x82>
    108a:	27e000ef          	jal	1308 <printf>
    108e:	bf4d                	j	1040 <test_exit+0x3c>
        if(waitret == cpid) printf("exit OK.\n");
    1090:	00001517          	auipc	a0,0x1
    1094:	ea850513          	add	a0,a0,-344 # 1f38 <__clone+0x72>
    ...
    10d0:	4881                	li	a7,0
{
    ...
    10e4:	ea068693          	add	a3,a3,-352 # 1f80 <digits>
    buf[16] = 0;
    ...
    1310:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    1340:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x58b0>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1344:	00001997          	auipc	s3,0x1
    1348:	c3c98993          	add	s3,s3,-964 # 1f80 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    187e:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedf7f>
    ...
    1890:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff181>
    ...
    18de:	00757713          	and	a4,a0,7
{
    ...
    190e:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e181>
    ...
    1932:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedf7f>
    1936:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff181>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19cc:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedf7f>
    ...
    19de:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff181>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a92:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedf7f>
    1a96:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff181>
