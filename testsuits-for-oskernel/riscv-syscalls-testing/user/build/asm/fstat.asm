...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/fstat:     file format elf64-littleriscv
...
void test_fstat() {
    ...
    101a:	05a50513          	add	a0,a0,90 # 2070 <__func__.0>
    ...
    1034:	f0850513          	add	a0,a0,-248 # 1f38 <__clone+0x54>
    1038:	437000ef          	jal	1c6e <open>
	int ret = fstat(fd, &kst);
    103c:	00001597          	auipc	a1,0x1
    1040:	fb458593          	add	a1,a1,-76 # 1ff0 <kst>
    1044:	5b5000ef          	jal	1df8 <fstat>
    1048:	842a                	mv	s0,a0
	printf("fstat ret: %d\n", ret);
    104a:	85aa                	mv	a1,a0
    104c:	00001517          	auipc	a0,0x1
    1050:	efc50513          	add	a0,a0,-260 # 1f48 <__clone+0x64>
    ...
    1060:	f9458593          	add	a1,a1,-108 # 1ff0 <kst>
    ...
    107e:	efe50513          	add	a0,a0,-258 # 1f78 <__clone+0x94>
    ...
    108a:	f5250513          	add	a0,a0,-174 # 1fd8 <__clone+0xf4>
    108e:	276000ef          	jal	1304 <puts>
    1092:	00001517          	auipc	a0,0x1
    1096:	fde50513          	add	a0,a0,-34 # 2070 <__func__.0>
    ...
    10b2:	eaa50513          	add	a0,a0,-342 # 1f58 <__clone+0x74>
    ...
    10ee:	4881                	li	a7,0
{
    ...
    1102:	f8268693          	add	a3,a3,-126 # 2080 <digits>
    buf[16] = 0;
    ...
    132e:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    135e:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x57b0>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1362:	00001997          	auipc	s3,0x1
    1366:	d1e98993          	add	s3,s3,-738 # 2080 <digits>
        if (!*s)
    ...
    159e:	a4e40413          	add	s0,s0,-1458 # 1fe8 <__clone+0x104>
...
size_t strlen(const char *s)
{
    ...
    189c:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefede7f>
    ...
    18ae:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff081>
    ...
    18fc:	00757713          	and	a4,a0,7
{
    ...
    192c:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e081>
    ...
    1950:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefede7f>
    1954:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff081>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19ea:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefede7f>
    ...
    19fc:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff081>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1ab0:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefede7f>
    1ab4:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff081>
