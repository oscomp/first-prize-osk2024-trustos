...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/clone:     file format elf64-littleriscv
...
void test_clone(void){
    ...
    1022:	f3250513          	add	a0,a0,-206 # 1f50 <__clone+0x4a>
void test_clone(void){
    ...
    1032:	fca50513          	add	a0,a0,-54 # 3ff8 <__func__.0>
    1036:	2f0000ef          	jal	1326 <puts>
    103a:	00001517          	auipc	a0,0x1
    103e:	f2e50513          	add	a0,a0,-210 # 1f68 <__clone+0x62>
    ...
    1050:	fa460613          	add	a2,a2,-92 # 1ff0 <stack>
    1054:	4581                	li	a1,0
    ...
    1066:	f8e40413          	add	s0,s0,-114 # 3ff0 <child_pid>
    ...
    107c:	f6050513          	add	a0,a0,-160 # 1fd8 <__clone+0xd2>
    1080:	2a6000ef          	jal	1326 <puts>
    1084:	00003517          	auipc	a0,0x3
    1088:	f7450513          	add	a0,a0,-140 # 3ff8 <__func__.0>
    108c:	29a000ef          	jal	1326 <puts>
    1090:	00001517          	auipc	a0,0x1
    1094:	ed850513          	add	a0,a0,-296 # 1f68 <__clone+0x62>
    ...
    10b4:	f1050513          	add	a0,a0,-240 # 1fc0 <__clone+0xba>
    10b8:	290000ef          	jal	1348 <printf>
    10bc:	bf75                	j	1078 <test_clone+0x5c>
    assert(child_pid != -1);
    10be:	00001517          	auipc	a0,0x1
    10c2:	eba50513          	add	a0,a0,-326 # 1f78 <__clone+0x72>
    ...
    10d4:	ec850513          	add	a0,a0,-312 # 1f98 <__clone+0x92>
    ...
    1110:	4881                	li	a7,0
{
    ...
    1124:	ee868693          	add	a3,a3,-280 # 4008 <digits>
    buf[16] = 0;
    ...
    1350:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    1380:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x3828>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1384:	00003997          	auipc	s3,0x3
    1388:	c8498993          	add	s3,s3,-892 # 4008 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    18be:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefebef7>
    ...
    18d0:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00fd0f9>
    ...
    191e:	00757713          	and	a4,a0,7
{
    ...
    194e:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100c0f9>
    ...
    1972:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefebef7>
    1976:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00fd0f9>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    1a0c:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefebef7>
    ...
    1a1e:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00fd0f9>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1ad2:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefebef7>
    1ad6:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00fd0f9>
