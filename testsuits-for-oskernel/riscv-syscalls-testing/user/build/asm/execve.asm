...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/execve:     file format elf64-littleriscv
...
void test_execve(void){
    ...
    100a:	e9250513          	add	a0,a0,-366 # 1e98 <__clone+0x2e>
void test_execve(void){
    100e:	f406                	sd	ra,40(sp)
    TEST_START(__func__);
    1010:	28c000ef          	jal	129c <puts>
    1014:	00001517          	auipc	a0,0x1
    1018:	edc50513          	add	a0,a0,-292 # 1ef0 <__func__.0>
    101c:	280000ef          	jal	129c <puts>
    1020:	00001517          	auipc	a0,0x1
    1024:	e9050513          	add	a0,a0,-368 # 1eb0 <__clone+0x46>
    ...
    1034:	e9050513          	add	a0,a0,-368 # 1ec0 <__clone+0x56>
    ...
    1046:	e8e50513          	add	a0,a0,-370 # 1ed0 <__clone+0x66>
    ...
    1086:	4881                	li	a7,0
{
    ...
    109a:	e6a68693          	add	a3,a3,-406 # 1f00 <digits>
    buf[16] = 0;
    ...
    12c6:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    12f6:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x5930>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    12fa:	00001997          	auipc	s3,0x1
    12fe:	c0698993          	add	s3,s3,-1018 # 1f00 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    1822:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedfff>
    ...
    1834:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff201>
    ...
    1882:	00757713          	and	a4,a0,7
{
    ...
    18b2:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e201>
    ...
    18d6:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedfff>
    18da:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff201>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    1970:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedfff>
    ...
    1982:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff201>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a36:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedfff>
    1a3a:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff201>
...
0000000000001d8a <sys_linkat>:
    register long a4 __asm__("a4") = e;
    1d8a:	1702                	sll	a4,a4,0x20
    register long a7 __asm__("a7") = n;
    1d8c:	02500893          	li	a7,37
    register long a4 __asm__("a4") = e;
    1d90:	9301                	srl	a4,a4,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1d92:	00000073          	ecall
...
0000000000001d9a <sys_unlinkat>:
    register long a2 __asm__("a2") = c;
    1d9a:	1602                	sll	a2,a2,0x20
    register long a7 __asm__("a7") = n;
    1d9c:	02300893          	li	a7,35
    register long a2 __asm__("a2") = c;
    1da0:	9201                	srl	a2,a2,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1da2:	00000073          	ecall
