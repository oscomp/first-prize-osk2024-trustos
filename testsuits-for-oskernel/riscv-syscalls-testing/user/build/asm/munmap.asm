...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/munmap:     file format elf64-littleriscv
...
void test_munmap(void){
    ...
    101c:	0a050513          	add	a0,a0,160 # 20b8 <__func__.0>
    ...
    1038:	f4c50513          	add	a0,a0,-180 # 1f80 <__clone+0x56>
    103c:	479000ef          	jal	1cb4 <open>
    1040:	842a                	mv	s0,a0
    write(fd, str, strlen(str));
    1042:	00001517          	auipc	a0,0x1
    1046:	f4e50513          	add	a0,a0,-178 # 1f90 <__clone+0x66>
    104a:	075000ef          	jal	18be <strlen>
    104e:	862a                	mv	a2,a0
    1050:	00001597          	auipc	a1,0x1
    1054:	f4058593          	add	a1,a1,-192 # 1f90 <__clone+0x66>
    1058:	8522                	mv	a0,s0
    105a:	499000ef          	jal	1cf2 <write>
    fstat(fd, &kst);
    105e:	00001497          	auipc	s1,0x1
    1062:	fda48493          	add	s1,s1,-38 # 2038 <kst>
    1066:	85a6                	mv	a1,s1
    1068:	8522                	mv	a0,s0
    ...
    1074:	f4050513          	add	a0,a0,-192 # 1fb0 <__clone+0x86>
    ...
    10a0:	f3450513          	add	a0,a0,-204 # 1fd0 <__clone+0xa6>
    ...
    10ae:	f3e50513          	add	a0,a0,-194 # 1fe8 <__clone+0xbe>
    ...
    10c0:	f6450513          	add	a0,a0,-156 # 2020 <__clone+0xf6>
    10c4:	286000ef          	jal	134a <puts>
    10c8:	00001517          	auipc	a0,0x1
    10cc:	ff050513          	add	a0,a0,-16 # 20b8 <__func__.0>
    ...
    10de:	e9650513          	add	a0,a0,-362 # 1f70 <__clone+0x46>
}
    ...
    10ea:	f1a50513          	add	a0,a0,-230 # 2000 <__clone+0xd6>
    10ee:	4fc000ef          	jal	15ea <panic>
	if (ret == 0)
    10f2:	b7d1                	j	10b6 <test_munmap+0xb2>
	printf("mmap error.\n");
    10f4:	00001517          	auipc	a0,0x1
    10f8:	ecc50513          	add	a0,a0,-308 # 1fc0 <__clone+0x96>
    ...
    1374:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    13a4:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x5768>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    13a8:	00001997          	auipc	s3,0x1
    13ac:	d2098993          	add	s3,s3,-736 # 20c8 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    18e2:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefede37>
    ...
    18f4:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff039>
    ...
    1942:	00757713          	and	a4,a0,7
{
    ...
    1972:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e039>
    ...
    1996:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefede37>
    199a:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff039>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    1a30:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefede37>
    ...
    1a42:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff039>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1af6:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefede37>
    1afa:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff039>
