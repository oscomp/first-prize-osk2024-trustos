...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/close:     file format elf64-littleriscv
...
void test_close(void) {
    ...
    101a:	f8250513          	add	a0,a0,-126 # 1f98 <__func__.0>
    ...
    106c:	f0050513          	add	a0,a0,-256 # 1f68 <__clone+0x96>
    1070:	2a4000ef          	jal	1314 <printf>
	
    TEST_END(__func__);
    1074:	00001517          	auipc	a0,0x1
    1078:	f0c50513          	add	a0,a0,-244 # 1f80 <__clone+0xae>
    107c:	276000ef          	jal	12f2 <puts>
    1080:	00001517          	auipc	a0,0x1
    1084:	f1850513          	add	a0,a0,-232 # 1f98 <__func__.0>
    ...
    1094:	e8850513          	add	a0,a0,-376 # 1f18 <__clone+0x46>
}
    ...
    10a0:	eac50513          	add	a0,a0,-340 # 1f48 <__clone+0x76>
    ...
    10dc:	4881                	li	a7,0
{
    ...
    10f0:	ebc68693          	add	a3,a3,-324 # 1fa8 <digits>
    buf[16] = 0;
    ...
    131c:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    134c:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x5888>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1350:	00001997          	auipc	s3,0x1
    1354:	c5898993          	add	s3,s3,-936 # 1fa8 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    188a:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedf57>
    ...
    189c:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff159>
    ...
    18ea:	00757713          	and	a4,a0,7
{
    ...
    191a:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e159>
    ...
    193e:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedf57>
    1942:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff159>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19d8:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedf57>
    ...
    19ea:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff159>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a9e:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedf57>
    1aa2:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff159>
