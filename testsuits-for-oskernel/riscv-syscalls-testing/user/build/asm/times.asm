...
/home/brightnight/OScompetition/6.13晚final_main/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/times：     文件格式 elf64-littleriscv
...
void test_times() {
    ...
    1018:	fbc50513          	addi	a0,a0,-68 # 1fd0 <__func__.0>
    ...
    1030:	f8450513          	addi	a0,a0,-124 # 1fb0 <mytimes>
    1034:	4cf000ef          	jal	ra,1d02 <times>
	assert(test_ret >= 0);
    ...
    105c:	f2850513          	addi	a0,a0,-216 # 1f80 <__clone+0xc6>
    1060:	2ae000ef          	jal	ra,130e <puts>
    1064:	00001517          	auipc	a0,0x1
    1068:	f6c50513          	addi	a0,a0,-148 # 1fd0 <__func__.0>
    106c:	2a2000ef          	jal	ra,130e <puts>
}
    1070:	60a2                	ld	ra,8(sp)
	TEST_END(__func__);
    1072:	00001517          	auipc	a0,0x1
    1076:	e8e50513          	addi	a0,a0,-370 # 1f00 <__clone+0x46>
}
    ...
    1082:	e9250513          	addi	a0,a0,-366 # 1f10 <__clone+0x56>
    ...
    10a2:	05a1                	addi	a1,a1,8
{
    ...
    10aa:	429000ef          	jal	ra,1cd2 <exit>
	return 0;
}
    ...
    10b8:	f406                	sd	ra,40(sp)
{
    ...
    10c6:	f1e60613          	addi	a2,a2,-226 # 1fe0 <digits>
    buf[16] = 0;
    ...
    11e6:	29d000ef          	jal	ra,1c82 <write>
    i++;
    if (i < 0)
        puts("printint error");
    ...
    11fc:	de860613          	addi	a2,a2,-536 # 1fe0 <digits>
    buf[16] = 0;
    ...
    12da:	4501                	li	a0,0
{
    ...
    read(stdin, &byte, 1);
    12e2:	197000ef          	jal	ra,1c78 <read>
}
    ...
    12fa:	4505                	li	a0,1
{
    ...
    return write(stdout, &byte, 1);
    1302:	181000ef          	jal	ra,1c82 <write>
}
...
000000000000130e <puts>:
{
    ...
    1316:	57e000ef          	jal	ra,1894 <strlen>
    131a:	862a                	mv	a2,a0
    131c:	85a2                	mv	a1,s0
    131e:	4505                	li	a0,1
    1320:	163000ef          	jal	ra,1c82 <write>
}
    ...
    1338:	18bc                	addi	a5,sp,120
{
    ...
    1362:	c32b0b13          	addi	s6,s6,-974 # 1f90 <__clone+0xd6>
    buf[i++] = '0';
    1366:	830aca93          	xori	s5,s5,-2000
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    136a:	00001997          	auipc	s3,0x1
    136e:	c7698993          	addi	s3,s3,-906 # 1fe0 <digits>
        if (!*s)
    ...
    1390:	8622                	mv	a2,s0
    1392:	4505                	li	a0,1
    1394:	0ef000ef          	jal	ra,1c82 <write>
        if (l)
    ...
    write(f, s, l);
    14da:	7a8000ef          	jal	ra,1c82 <write>
    ...
    1524:	8622                	mv	a2,s0
    1526:	4505                	li	a0,1
    1528:	75a000ef          	jal	ra,1c82 <write>
        if (l)
    ...
    1572:	8522                	mv	a0,s0
    1574:	40c000ef          	jal	ra,1980 <strnlen>
    write(f, s, l);
    1578:	0005061b          	sext.w	a2,a0
    157c:	85a2                	mv	a1,s0
    157e:	4505                	li	a0,1
    1580:	702000ef          	jal	ra,1c82 <write>
        s += 2;
    ...
    return write(stdout, &byte, 1);
    1594:	6ee000ef          	jal	ra,1c82 <write>
    char byte = c;
...
size_t strlen(const char *s)
{
    ...
    18ba:	6e25b583          	ld	a1,1762(a1) # 1f98 <__clone+0xde>
    18be:	00000617          	auipc	a2,0x0
    18c2:	6e263603          	ld	a2,1762(a2) # 1fa0 <__clone+0xe6>
    ...
    18f2:	00757713          	andi	a4,a0,7
{
    ...
    1922:	68a53503          	ld	a0,1674(a0) # 1fa8 <__clone+0xee>
    ...
    1934:	6688b883          	ld	a7,1640(a7) # 1f98 <__clone+0xde>
    1938:	00000817          	auipc	a6,0x0
    193c:	66883803          	ld	a6,1640(a6) # 1fa0 <__clone+0xe6>
    1940:	431d                	li	t1,7
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19c2:	5da63603          	ld	a2,1498(a2) # 1f98 <__clone+0xde>
    19c6:	00000817          	auipc	a6,0x0
    19ca:	5da83803          	ld	a6,1498(a6) # 1fa0 <__clone+0xe6>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1ba4:	3f88b883          	ld	a7,1016(a7) # 1f98 <__clone+0xde>
    1ba8:	00000817          	auipc	a6,0x0
    1bac:	3f883803          	ld	a6,1016(a6) # 1fa0 <__clone+0xe6>
    1bb0:	431d                	li	t1,7
