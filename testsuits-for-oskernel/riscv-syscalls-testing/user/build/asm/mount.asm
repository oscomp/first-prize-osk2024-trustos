...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/mount:     file format elf64-littleriscv
...
void test_mount() {
    ...
    100a:	f6250513          	add	a0,a0,-158 # 1f68 <__clone+0x2c>
void test_mount() {
    ...
    101a:	09a50513          	add	a0,a0,154 # 20b0 <__func__.0>
    101e:	33e000ef          	jal	135c <puts>
    1022:	00001517          	auipc	a0,0x1
    1026:	f5e50513          	add	a0,a0,-162 # 1f80 <__clone+0x44>
    102a:	332000ef          	jal	135c <puts>

	printf("Mounting dev:%s to %s\n", device, mntpoint);
    102e:	00001617          	auipc	a2,0x1
    1032:	00260613          	add	a2,a2,2 # 2030 <mntpoint>
    1036:	00001597          	auipc	a1,0x1
    103a:	03a58593          	add	a1,a1,58 # 2070 <device>
    103e:	00001517          	auipc	a0,0x1
    1042:	f5250513          	add	a0,a0,-174 # 1f90 <__clone+0x54>
    1046:	338000ef          	jal	137e <printf>
	int ret = mount(device, mntpoint, fs_type, 0, NULL);
    104a:	00001597          	auipc	a1,0x1
    104e:	fe658593          	add	a1,a1,-26 # 2030 <mntpoint>
    1052:	4701                	li	a4,0
    1054:	4681                	li	a3,0
    1056:	00001617          	auipc	a2,0x1
    105a:	f5260613          	add	a2,a2,-174 # 1fa8 <__clone+0x6c>
    105e:	00001517          	auipc	a0,0x1
    1062:	01250513          	add	a0,a0,18 # 2070 <device>
    1066:	6bd000ef          	jal	1f22 <mount>
    106a:	842a                	mv	s0,a0
	printf("mount return: %d\n", ret);
    106c:	85aa                	mv	a1,a0
    106e:	00001517          	auipc	a0,0x1
    1072:	f4250513          	add	a0,a0,-190 # 1fb0 <__clone+0x74>
    ...
    1080:	f4c50513          	add	a0,a0,-180 # 1fc8 <__clone+0x8c>
    1084:	2fa000ef          	jal	137e <printf>
		ret = umount(mntpoint);
    1088:	00001517          	auipc	a0,0x1
    108c:	fa850513          	add	a0,a0,-88 # 2030 <mntpoint>
    1090:	69f000ef          	jal	1f2e <umount>
    1094:	85aa                	mv	a1,a0
		printf("umount return: %d\n", ret);
    1096:	00001517          	auipc	a0,0x1
    109a:	f4a50513          	add	a0,a0,-182 # 1fe0 <__clone+0xa4>
    109e:	2e0000ef          	jal	137e <printf>
	}

	TEST_END(__func__);
    10a2:	00001517          	auipc	a0,0x1
    10a6:	f7650513          	add	a0,a0,-138 # 2018 <__clone+0xdc>
    10aa:	2b2000ef          	jal	135c <puts>
    10ae:	00001517          	auipc	a0,0x1
    10b2:	00250513          	add	a0,a0,2 # 20b0 <__func__.0>
    ...
    10c2:	ec250513          	add	a0,a0,-318 # 1f80 <__clone+0x44>
}
    ...
    10ce:	f2e50513          	add	a0,a0,-210 # 1ff8 <__clone+0xbc>
...
int main(int argc,char *argv[]) {
    ...
    10fc:	f7850513          	add	a0,a0,-136 # 2070 <device>
    ...
    1110:	f2450513          	add	a0,a0,-220 # 2030 <mntpoint>
    ...
    1146:	4881                	li	a7,0
{
    ...
    115a:	f6a68693          	add	a3,a3,-150 # 20c0 <digits>
    buf[16] = 0;
    ...
    1386:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    13b6:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x5770>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    13ba:	00001997          	auipc	s3,0x1
    13be:	d0698993          	add	s3,s3,-762 # 20c0 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    18f4:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefede3f>
    ...
    1906:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff041>
    ...
    1954:	00757713          	and	a4,a0,7
{
    ...
    1984:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e041>
    ...
    19a8:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefede3f>
    19ac:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff041>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    1a42:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefede3f>
    ...
    1a54:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff041>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1b08:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefede3f>
    1b0c:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff041>
...
0000000000001e5c <sys_linkat>:
    register long a4 __asm__("a4") = e;
    1e5c:	1702                	sll	a4,a4,0x20
    register long a7 __asm__("a7") = n;
    1e5e:	02500893          	li	a7,37
    register long a4 __asm__("a4") = e;
    1e62:	9301                	srl	a4,a4,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1e64:	00000073          	ecall
