...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/getppid:     file format elf64-littleriscv
    ...
    100a:	eb250513          	add	a0,a0,-334 # 1eb8 <__clone+0x2c>
{
    ...
    1024:	eb050513          	add	a0,a0,-336 # 1ed0 <__clone+0x44>
    ...
    106c:	e9850513          	add	a0,a0,-360 # 1f00 <__clone+0x74>
    ...
    10a8:	4881                	li	a7,0
{
    ...
    10bc:	e8868693          	add	a3,a3,-376 # 1f40 <digits>
    buf[16] = 0;
    ...
    12e8:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    1318:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x58f0>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    131c:	00001997          	auipc	s3,0x1
    1320:	c2498993          	add	s3,s3,-988 # 1f40 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    1844:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedfbf>
    ...
    1856:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff1c1>
    ...
    18a4:	00757713          	and	a4,a0,7
{
    ...
    18d4:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e1c1>
    ...
    18f8:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedfbf>
    18fc:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff1c1>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    1992:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedfbf>
    ...
    19a4:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff1c1>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a58:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedfbf>
    1a5c:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff1c1>
