...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/getdents:     file format elf64-littleriscv
...
void test_getdents(void){
    ...
    101c:	1b050513          	add	a0,a0,432 # 21c8 <__func__.0>
    1020:	2fc000ef          	jal	131c <puts>
    1024:	00001517          	auipc	a0,0x1
    1028:	f1c50513          	add	a0,a0,-228 # 1f40 <__clone+0x44>
    ...
    1036:	f1e50513          	add	a0,a0,-226 # 1f50 <__clone+0x54>
    ...
    1068:	f0450513          	add	a0,a0,-252 # 1f68 <__clone+0x6c>
    ...
    107a:	f6558593          	add	a1,a1,-155 # 1fdb <buf+0x13>
    107e:	00001517          	auipc	a0,0x1
    1082:	f1a50513          	add	a0,a0,-230 # 1f98 <__clone+0x9c>
	...
	*/
    ...
    108e:	f0650513          	add	a0,a0,-250 # 1f90 <__clone+0x94>
    ...
    10a0:	f1450513          	add	a0,a0,-236 # 1fb0 <__clone+0xb4>
    10a4:	278000ef          	jal	131c <puts>
    10a8:	00001517          	auipc	a0,0x1
    10ac:	12050513          	add	a0,a0,288 # 21c8 <__func__.0>
    ...
    10be:	e8650513          	add	a0,a0,-378 # 1f40 <__clone+0x44>
}
    ...
    10ca:	eb250513          	add	a0,a0,-334 # 1f78 <__clone+0x7c>
    ...
    1106:	4881                	li	a7,0
{
    ...
    111a:	0c268693          	add	a3,a3,194 # 21d8 <digits>
    buf[16] = 0;
    ...
    1346:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    1376:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x5658>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    137a:	00001997          	auipc	s3,0x1
    137e:	e5e98993          	add	s3,s3,-418 # 21d8 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    18b4:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedd27>
    ...
    18c6:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00fef29>
    ...
    1914:	00757713          	and	a4,a0,7
{
    ...
    1944:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100df29>
    ...
    1968:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedd27>
    196c:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00fef29>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    1a02:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedd27>
    ...
    1a14:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00fef29>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1ac8:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedd27>
    1acc:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00fef29>
