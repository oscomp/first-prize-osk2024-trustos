...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/dup:     file format elf64-littleriscv
...
void test_dup(){
    ...
    1070:	e8c50513          	add	a0,a0,-372 # 1ef8 <__clone+0x54>
    ...
    10ae:	4881                	li	a7,0
{
    ...
    10c2:	e9a68693          	add	a3,a3,-358 # 1f58 <digits>
    buf[16] = 0;
    ...
    12ee:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    131e:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x58d8>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1322:	00001997          	auipc	s3,0x1
    1326:	c3698993          	add	s3,s3,-970 # 1f58 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    185c:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedfa7>
    ...
    186e:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff1a9>
    ...
    18bc:	00757713          	and	a4,a0,7
{
    ...
    18ec:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e1a9>
    ...
    1910:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedfa7>
    1914:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff1a9>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19aa:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedfa7>
    ...
    19bc:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff1a9>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a70:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedfa7>
    1a74:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff1a9>
