...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/getcwd:     file format elf64-littleriscv
...
void test_getcwd(void){
   ...
   TEST_START(__func__);
    ...
    100a:	ec250513          	add	a0,a0,-318 # 1ec8 <__clone+0x28>
void test_getcwd(void){
   ...
   TEST_START(__func__);
    ...
    1024:	ec050513          	add	a0,a0,-320 # 1ee0 <__clone+0x40>
   ...
   TEST_END(__func__);
    ...
    1080:	e9450513          	add	a0,a0,-364 # 1f10 <__clone+0x70>
    ...
    10bc:	4881                	li	a7,0
{
    ...
    10d0:	e7c68693          	add	a3,a3,-388 # 1f48 <digits>
    buf[16] = 0;
    ...
    12fc:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    132c:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x58e8>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1330:	00001997          	auipc	s3,0x1
    1334:	c1898993          	add	s3,s3,-1000 # 1f48 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    1858:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedfb7>
    ...
    186a:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff1b9>
    ...
    18b8:	00757713          	and	a4,a0,7
{
    ...
    18e8:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e1b9>
    ...
    190c:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedfb7>
    1910:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff1b9>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19a6:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedfb7>
    ...
    19b8:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff1b9>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1a6c:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedfb7>
    1a70:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff1b9>
...
0000000000001dc0 <sys_linkat>:
    register long a4 __asm__("a4") = e;
    1dc0:	1702                	sll	a4,a4,0x20
    register long a7 __asm__("a7") = n;
    1dc2:	02500893          	li	a7,37
    register long a4 __asm__("a4") = e;
    1dc6:	9301                	srl	a4,a4,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2), "r"(a3), "r"(a4))
    1dc8:	00000073          	ecall
...
0000000000001dd0 <sys_unlinkat>:
    register long a2 __asm__("a2") = c;
    1dd0:	1602                	sll	a2,a2,0x20
    register long a7 __asm__("a7") = n;
    1dd2:	02300893          	li	a7,35
    register long a2 __asm__("a2") = c;
    1dd6:	9201                	srl	a2,a2,0x20
    __asm_syscall("r"(a7), "0"(a0), "r"(a1), "r"(a2))
    1dd8:	00000073          	ecall
