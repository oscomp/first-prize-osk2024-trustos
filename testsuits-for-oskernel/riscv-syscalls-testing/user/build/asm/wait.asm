...
/home/windflower/Desktop/oskernel2024-trustos/testsuits-for-oskernel/riscv-syscalls-testing/user/build/riscv64/wait:     file format elf64-littleriscv
...
void test_wait(void){
    ...
    1018:	fb450513          	add	a0,a0,-76 # 1fc8 <__func__.0>
    101c:	2ea000ef          	jal	1306 <puts>
    1020:	00001517          	auipc	a0,0x1
    1024:	f0850513          	add	a0,a0,-248 # 1f28 <__clone+0x42>
    1028:	2de000ef          	jal	1306 <puts>
    int cpid, wstatus;
    cpid = fork();
    102c:	4b1000ef          	jal	1cdc <fork>
    if(cpid == 0){
    ...
    1048:	f6c50513          	add	a0,a0,-148 # 1fb0 <__clone+0xca>
    104c:	2ba000ef          	jal	1306 <puts>
    1050:	00001517          	auipc	a0,0x1
    1054:	f7850513          	add	a0,a0,-136 # 1fc8 <__func__.0>
    1058:	2ae000ef          	jal	1306 <puts>
    105c:	00001517          	auipc	a0,0x1
    1060:	ecc50513          	add	a0,a0,-308 # 1f28 <__clone+0x42>
    ...
    108a:	f1250513          	add	a0,a0,-238 # 1f98 <__clone+0xb2>
    ...
    109e:	ed650513          	add	a0,a0,-298 # 1f70 <__clone+0x8a>
    ...
    10b0:	ea450513          	add	a0,a0,-348 # 1f50 <__clone+0x6a>
    ...
    10f0:	4881                	li	a7,0
{
    ...
    1104:	ed868693          	add	a3,a3,-296 # 1fd8 <digits>
    buf[16] = 0;
    ...
    1330:	013c                	add	a5,sp,136
{
    ...
    buf[i++] = '0';
    1360:	830a8a93          	add	s5,s5,-2000 # 7830 <digits+0x5858>
        buf[i++] = digits[x >> (sizeof(uint64) * 8 - 4)];
    1364:	00001997          	auipc	s3,0x1
    1368:	c7498993          	add	s3,s3,-908 # 1fd8 <digits>
        if (!*s)
...
size_t strlen(const char *s)
{
    ...
    189e:	eff58593          	add	a1,a1,-257 # fffffffffefefeff <digits+0xfffffffffefedf27>
    ...
    18b0:	10160613          	add	a2,a2,257 # fffffffff0101101 <digits+0xfffffffff00ff129>
    ...
    18fe:	00757713          	and	a4,a0,7
{
    ...
    192e:	10170713          	add	a4,a4,257 # 1010101 <digits+0x100e129>
    ...
    1952:	eff88893          	add	a7,a7,-257 # fffffffffefefeff <digits+0xfffffffffefedf27>
    1956:	10180813          	add	a6,a6,257 # fffffffff0101101 <digits+0xfffffffff00ff129>
...
char *strcpy(char *restrict d, const char *s)
{
    ...
    19ec:	eff60613          	add	a2,a2,-257 # fffffffffefefeff <digits+0xfffffffffefedf27>
    ...
    19fe:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff129>
...
char *strncpy(char *restrict d, const char *s, size_t n)
{
    ...
    1ab2:	eff80813          	add	a6,a6,-257 # fffffffffefefeff <digits+0xfffffffffefedf27>
    1ab6:	10168693          	add	a3,a3,257 # fffffffff0101101 <digits+0xfffffffff00ff129>
