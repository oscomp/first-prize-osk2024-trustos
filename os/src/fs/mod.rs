...
fn create_file(
    ...
    debug!(
        "[create_file],cwd={},path={},flags={:?},abs_path={},parent_path={},child_name={}",
        cwd, path, flags, abs_path, parent_path, child_name
    );
    ...
    return parent_dir
        ...
        .map(|vfile| {
            ...
            let osinode =
                OSInode::new(readable, writable, vfile, Some(Arc::downgrade(&parent_dir)));
